...
async function main(jettonAmount: string, lockupPeriod: number | bigint) {
...
const jettonAmount: string = "1"  // one token
const lockupPeriod: bigint = 1n;  // one second
main(jettonAmount, lockupPeriod);
